...
public class UserService {
    ...
    public List<Model_User_Account> getUser(int exitUser) throws SQLException{
        ...
        PreparedStatement ps= (PreparedStatement) con.prepareStatement(userAccount);
    ...
    //SQL
    private final String userAccount= "SELECT id, userName, gender, imageString FROM user_account WHERE  status = '1' AND id <> ?";
